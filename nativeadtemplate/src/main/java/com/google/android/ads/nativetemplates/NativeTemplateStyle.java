...
public class NativeTemplateStyle {
  ...
  // Call to action background color.
  private int callToActionBackgroundColorInt;
  ...
  public int getCallToActionBackgroundColorInt() {
    return callToActionBackgroundColorInt;
  }
  ...
  public static class Builder {
    ...
    public Builder withCallToActionBackgroundColorInt(int callToActionBackgroundColorInt) {
      this.styles.callToActionBackgroundColorInt = callToActionBackgroundColorInt;
      return this;
    }
