 ...
 */
class ExpandCollapseController<T: ExpandableGroup<P, C>,P: Parent, C: Child>(private val expandableList: ExpandableList<T, P, C>, private val listener: ExpandCollapseListener?) {
