package com.kryptkode.template.app.utils.expandable;
...
import com.kryptkode.template.app.utils.expandable.ParentViewHolder.ParentViewHolderExpandCollapseListener;
import com.kryptkode.template.app.utils.expandable.model.ExpandableWrapper;
import com.kryptkode.template.app.utils.expandable.model.Parent;
...
public abstract class ExpandableRecyclerAdapter<P extends Parent<C>, C, PVH extends ParentViewHolder, CVH extends ChildViewHolder>
    ...
    public void collapseParent(@NonNull P parent) {
        ExpandableWrapper<P, C> parentWrapper = new ExpandableWrapper<P, C>(parent);
        int flatParentPosition = mFlatItemList.indexOf(parentWrapper);
        if (flatParentPosition == INVALID_FLAT_POSITION) {
            return;
        }
